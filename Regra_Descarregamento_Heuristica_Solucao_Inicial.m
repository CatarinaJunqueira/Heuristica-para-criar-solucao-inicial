...
function [MovGeral, Navio] = Rd_Heuristica_Solucao_Inicial(Navio,NPorto,porto)
...
% descarregados, mas que não tinham como destino final este porto.
 if nnz(patio_transb) ~=0
    [Navio,Mov_Patio,Seq_Retirada] = Regra_Retirada_Heuristica_Solucao_Inicial(patio_transb,Navio,porto);
 end
end
