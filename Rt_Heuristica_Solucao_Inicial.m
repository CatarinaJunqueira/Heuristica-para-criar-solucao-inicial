function [Navio,Mov_Patio,Seq_Retirada] = Rt_Heuristica_Solucao_Inicial(P,Navio,porto) 
%-------------------------------------------------------------%
...
Seq_Retirada=zeros(1,size(C,1));
    for i=1:size(C,1)
        ...
        [Navio] = Rc_Heuristica_Solucao_Inicial(Navio,conteiner_sair,porto,altura_max);%chamando a regra de carregamento no navio                       
        %-------------------------------------------------------------%
